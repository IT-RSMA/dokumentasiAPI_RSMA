...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800 flex flex-col">
      ...
      {/* Perubahan: justify-center dihapus, padding top (pt) diubah jadi pt-16 agar posisi ada di atas tengah */}
      <main className="flex-1 w-full max-w-4xl mx-auto px-8 pt-16 pb-12 flex flex-col">
        ...
        {/* Card: Production Environment Key */}
        <div className="w-full bg-white rounded-xl border border-slate-200 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col">
          
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-[15px] font-semibold text-[#14B8A6] flex items-center gap-2">
          ...
          >
            ...
            <div
              className={`font-mono text-sm text-slate-600 break-all transition-all duration-300 leading-relaxed ${
                !isRevealed ? "blur-[5px] select-none" : "blur-none"
              }`}
            >
              {token}
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-auto">
            <button className="flex-1 bg-[#233876] hover:bg-blue-900 text-white py-3 px-4 rounded-lg text-[15px] font-semibold flex justify-center items-center transition-colors shadow-sm">
              Regenerate Token
            </button>
            <button
              onClick={handleCopy}
              className="flex-1 bg-white hover:bg-[#F0FDFB] border border-[#14B8A6] text-[#0D9488] py-3 px-4 rounded-lg text-[15px] font-semibold flex justify-center items-center transition-colors shadow-sm"
            >
              {copyText}
            </button>
            <button className="flex-1 bg-white hover:bg-slate-50 border border-slate-400 text-[#475569] py-3 px-4 rounded-lg text-[15px] font-semibold flex justify-center items-center transition-colors shadow-sm">
              Use in Playground
            </button>
          </div>
